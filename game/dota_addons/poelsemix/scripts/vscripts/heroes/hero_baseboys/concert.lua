...
function Phantasm( keys )
	...
	for i=1, images_count do
		...
		if caster:HasModifier("modifier_gunpowder") then			
			local gun_ability = caster:FindAbilityByName("gunpowder_datadriven")
			gun_ability:ApplyDataDrivenModifier(caster, illsuion, "modifier_gunpowder", nil)
		end
